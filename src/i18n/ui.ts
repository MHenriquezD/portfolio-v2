...
const es = {
  ...
  'proyectos.descripcion': 'Una selección de mis trabajos más recientes y relevantes.',
  ...
  'egg.konami.desc': '↑↑↓↓←→←→BA',
  'egg.konami.hint': 'El Código Konami de siempre: 30 vidas extra si lo recuerdas',
  ...
  'egg.zelda.hint': 'Nombra a la princesa de Hyrule con el teclado',
  'egg.zelda.hintTactil': 'Dibuja con el dedo la inicial de la princesa de Hyrule',
...
const en: Record<keyof typeof es, string> = {
  ...
  'proyectos.descripcion': 'A selection of my most recent and relevant work.',
  ...
  'egg.konami.nombre': 'Konami Code',
  'egg.konami.desc': '↑↑↓↓←→←→BA',
  'egg.konami.hint': 'The classic Konami Code: 30 extra lives if you remember it',
  ...
  'egg.zelda.hint': 'Type the name of the princess of Hyrule on your keyboard',
  'egg.zelda.hintTactil': 'Draw the initial of the princess of Hyrule with your finger',
